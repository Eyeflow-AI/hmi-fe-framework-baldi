...
export default function AddQueryDialog({
  open,
  setOpen,
  pageOptions,
  existingQueries,
  ...
  const handleAddQuery = () => {
    ...
    const searchMethodFormat =
      pageOptions?.options?.expectedValuesFormats?.find(
        (method) => method.type === searchMethod
      )?.format;
  ...
  return (
    <Dialog onClose={handleClose} open={open}>
      <DialogTitle textAlign={"center"}>{t("add_query")}</DialogTitle>
      <DialogContent
        sx={{
          display: "flex",
